namespace AutomotiveRepairShop
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            //Get LowestMileage
            Console.WriteLine(repairShop.GetLowestMileage()); //Damage: Cylinder misfire, Vehicle: WAUZZZ8K9FA123456 (66000 km) //Report
            Console.WriteLine(repairShop.Report()); //Vehicles in the preparatory: //Damage: Overheating issue, Vehicle: 5YJSA1CN7DFP12345 (80000 km) //Damage: Coolant leakage, Vehicle: JM1GJ1W56F1234567 (120000 km) //Damage: Timing belt failure, Vehicle: 2C3CDXAT4CH123456 (95000 km) //Damage: Cylinder misfire, Vehicle: WAUZZZ8K9FA123456 (66000 km) //Damage: Transmission failure, Vehicle: 1G1BL52P3RR123456 (150000 km)
        }
    }
}